...
router.get('/create', (req, res, next) => authorizeController.checkUser(req, res, next), (req, res, next) => controller.create(req, res, next))
...
router.get('/:id/update', (req, res, next) => authorizeController.checkUser(req, res, next), (req, res, next) => authorizeController.checkSnippetOwner(req, res, next), (req, res, next) => controller.update(req, res, next))
...
router.get('/:id/delete', (req, res, next) => authorizeController.checkUser(req, res, next), (req, res, next) => authorizeController.checkSnippetOwner(req, res, next), (req, res, next) => controller.delete(req, res, next))
